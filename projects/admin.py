...
class TaskAdmin(admin.ModelAdmin):
    list_display = ("title", "epic", "priority", "status", "deadline", "get_assigned_users")
...
class SubTaskAdmin(admin.ModelAdmin):
    list_display = ("title", "task", "priority", "status", "deadline", "get_assigned_users", "estimated_time", "time_tracked")
